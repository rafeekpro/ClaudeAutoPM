...
class InteractiveGuide {
  ...
  async installationFlow() {
    ...
    try {
      ...
      console.log('\n' + this.createFrame(
        ...
        'Your ClaudeAutoPM installation is ready! You can now:\n\n' +
        '1. 🔧 Configure your provider (GitHub/Azure DevOps)\n' +
        '2. 🤖 Learn about agent teams\n' +
        '3. 📋 Start your first PM workflow\n' +
        '4. 📚 Read the documentation\n\n' +
        'Type "autopm guide" anytime to return to this guide.',
        'Next Steps'
      ));
  ...
  async firstProjectFlow() {
    ...
    console.log(this.createStepFrame(
      ...
      '💡 Use these commands in Claude (not terminal):',
      [
