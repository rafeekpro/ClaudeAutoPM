...
exports.command = 'pm:epic-show';
exports.describe = 'epic-show';
...
exports.handler = async (argv) => {
  const spinner = createSpinner('Running pm:epic-show...');
  ...
  try {
    ...
    if (isClaudeCode) {
      ...
      console.log('Run: /pm:epic-show for intelligent epic details');
      return;
    }

    // Run the deterministic script
    const scriptPath = path.join(process.cwd(), '.claude', 'scripts', 'pm/epic-show.sh');
