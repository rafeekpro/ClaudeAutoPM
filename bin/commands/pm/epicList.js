...
exports.command = 'pm:epic-list';
exports.describe = 'epic-list';
...
exports.handler = async (argv) => {
  const spinner = createSpinner('Running pm:epic-list...');
  ...
  try {
    ...
    if (isClaudeCode) {
      ...
      console.log('Run: /pm:epic-list for intelligent epic listing');
      return;
    }

    // Run the deterministic script
    const scriptPath = path.join(process.cwd(), '.claude', 'scripts', 'pm/epic-list.sh');
