...
exports.command = 'pm:help';
exports.describe = 'help';
...
exports.handler = async (argv) => {
  const spinner = createSpinner('Running pm:help...');
  ...
  try {
    ...
    if (isClaudeCode) {
      ...
      console.log('Run: /pm:help for intelligent help documentation');
      return;
    }

    // Run the deterministic script
    const scriptPath = path.join(process.cwd(), '.claude', 'scripts', 'pm/help.sh');
