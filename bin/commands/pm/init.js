...
exports.command = 'pm:init';
exports.describe = 'init';
...
exports.handler = async (argv) => {
  const spinner = createSpinner('Running pm:init...');
  ...
  try {
    ...
    if (isClaudeCode) {
      ...
      console.log('Run: /pm:init for intelligent project initialization');
      return;
    }

    // Run the deterministic script
    const scriptPath = path.join(process.cwd(), '.claude', 'scripts', 'pm/init.sh');
