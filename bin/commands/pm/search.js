...
exports.command = 'pm:search';
exports.describe = 'search';
...
exports.handler = async (argv) => {
  const spinner = createSpinner('Running pm:search...');
  ...
  try {
    ...
    if (isClaudeCode) {
      ...
      console.log('Run: /pm:search for intelligent search functionality');
      return;
    }

    // Run the deterministic script
    const scriptPath = path.join(process.cwd(), '.claude', 'scripts', 'pm/search.sh');
