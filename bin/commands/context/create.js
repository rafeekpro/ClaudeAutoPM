 ...
 * Auto-migrated from context:create.md
 */
...
// --- Command Definition ---
exports.command = 'context:create';
exports.describe = 'Create Initial Context';
...
exports.handler = async (argv) => {
  const spinner = createSpinner('Executing context:create...');
