#!/bin/bash
# Azure DevOps Feature Status Script - Backward Compatible Wrapper
# Migrated to Node.js with backward compatibility for existing scripts
# Shows status of all features with progress metrics
# Usage: ./feature-status.sh [options]
...
NODE_SCRIPT="${PROJECT_ROOT}/bin/node/azure-feature-status.js"
